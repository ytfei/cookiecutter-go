...
<tr>
    <td align="center" style="word-wrap: break-word; width: 150.0; height: 150.0">
        <a href=https://github.com/ytfei>
            <img src=https://avatars.githubusercontent.com/u/769702?v=4 width="100;"  style="border-radius:50%;align-items:center;justify-content:center;overflow:hidden;padding-top:10px" alt=Evans/>
            <br />
            <sub style="font-size:14px"><b>Evans</b></sub>
        </a>
    </td>
</tr>
</table>
